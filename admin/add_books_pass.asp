...
sql="select title,ProductNo,etitle,body,ebody,ssfl,img,data from bookshh"
...
<%
Response.Write "<script>alert('书籍增加成功！点击继续添加！');window.location.href='add_books.asp';</script>" 
%>
