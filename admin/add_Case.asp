  ...
  <tr>
    <td height="30" bgcolor="#FFFFFF"><div align="center">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td height="30" bgcolor="#F7F7F7"><div align="center"><strong>增加工程</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><FORM method="post" name="myform" action="add_case_pass.asp">
      <table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#F7F7F7">
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">工程名称<font color="#FF0000"> (中文)</font></div></td>
          <td width="85%" bgcolor="#F7F7F7"><input name="title" type="text" id="title" size="40"></td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">工程名称<font color="#FF0000"> (英文)</font></div></td>
          <td bgcolor="#F7F7F7"><input name="etitle" type="text" id="etitle" size="40"></td>
        </tr>
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">工程分类</div></td>
          <td bgcolor="#F7F7F7"><select name="ssfl" id="select">
            <%
		  dim rsc
		  set rsc=server.CreateObject("adodb.recordset")
		  rsc.open "select * from case_fl",conn,1,1
		  while not rsc.eof
        ...
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">工程编号</div></td>
          <td bgcolor="#F7F7F7"><%
...
%><label>
        ...
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">工程略缩图</div></td>
        ...
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">工程介绍<font color="#FF0000"> (中文)</font></div></td>
...
<IFRAME ID="eWebEditor1" SRC="ewebeditor/ewebeditor.htm?id=body&style=popup" FRAMEBORDER="0" SCROLLING="no" WIDTH="100%" HEIGHT="400"></IFRAME> </td>
        ...
        <tr>
          <td bgcolor="#F7F7F7"><div align="center">工程介绍 <font color="#FF0000">(英文)</font></div></td>
