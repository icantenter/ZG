...
<% 
exec="select * from shop where id="& request.QueryString("id") 
  ...
  <tr>
    <td height="30" bgcolor="#FFFFFF"><div align="center">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td height="30" bgcolor="#F7F7F7"><div align="center"><strong>修改产品</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><FORM method="post" name="myform" action="updata_shop.asp">
      <table width="100%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#F7F7F7">
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">产品名称<font color="#FF0000"> (中文)</font></div></td>
        ...
        <tr>
		  ...
		  rsc.open "select * from shop_fl",conn,1,1
		  while not rsc.eof
        ...
        <tr>
          <td width="15%" bgcolor="#F7F7F7"><div align="center">产品介绍<font color="#FF0000"> (中文)</font></div></td>
...
<IFRAME ID="eWebEditor1" SRC="ewebeditor/ewebeditor.htm?id=body&style=popup" FRAMEBORDER="0" SCROLLING="no" WIDTH="100%" HEIGHT="400"></IFRAME></td>
        ...
        <tr>
          <td bgcolor="#F7F7F7"><div align="center">产品介绍 <font color="#FF0000">(英文)</font></div></td>
