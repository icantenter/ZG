          ...
          <td bgcolor=#791515 width=150 align="center"><b><font color="#FFFFFF" size="1"><img src="img/click.png" /></font></b><spacer type="block" width="5"></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class=xingcheng >
              <tr> 
                ...
                <td style="cursor: hand" onClick="outliner()" child="3ALL"  height="25">&nbsp;&nbsp;&nbsp;&nbsp;公司熔模精密铸造产品介绍  --- 点击展开详细</td>
              </tr>
                </table>
              </td>
  </tr>
...
<% 
exec="select * from about where title='熔模精密铸造介绍' " '如修改了名称,请在这里做相应修改
...
<table>
   ...
   <td height=25  width="600"  align="center" class="body" bgcolor="#c1c1c1">简阳川空精密铸钢熔模精密铸造产品一览</td>
              </tr>
                </table>
...
<%	
set rs=server.createobject("adodb.recordset") 
exec="select * from shop where ssfl=39 order by id desc" 
rs.open exec,conn,1,1 
if rs.eof then
response.Write "&nbsp;暂无产品！"
else
