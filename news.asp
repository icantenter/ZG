...
<div id="main_left1">
 ...
 <div id="newsmain">
 <div id="news"><table width="100%" border="0" cellpadding="0" cellspacing="2">
      <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="2">
  ...
  <tr> 
    <td  width="598" height="27" align="left" background="img/bg1.png"><img src="img/arrow_2.gif" /><strong><a href="enews.asp?id=<%=rs("id")%>" title="<%=rs("title")%>" class="news"><%=left(rs("title"),30)%></a></strong>&nbsp;&nbsp;&nbsp;<font class="body9"><%=left(rs("data"),40)%></font></td>
  </tr>
  <tr>
  <td><%=left(rs("body"),200)%>......</td>
  </tr>
</table>
</div>
...
'生成上一页下一页链接
    ...
    if page<=1 then
        ...
        Response.Write("<A HREF=" & action & "?" & temp & "Page=1><font color=#882b2b>首页</font></A> " & vbCrLf)
        Response.Write("<A HREF=" & action & "?" & temp & "Page=" & (Page-1) & "><font color=#882b2b>上一页</font></A> " & vbCrLf)
    end if
    if page>=pagecount then
        Response.Write ("下一页 " & vbCrLf)
        Response.Write ("尾页 " & vbCrLf)            
    else
        Response.Write("<A HREF=" & action & "?" & temp & "Page=" & (Page+1) & "><font color=#882b2b>下一页</font></A> " & vbCrLf)
        Response.Write("<A HREF=" & action & "?" & temp & "Page=" & pagecount & "><font color=#882b2b>尾页</font></A> " & vbCrLf)            
    end if
